...
| Route | Display Name | Group | Status | Current Purpose | Risk Level | Should Touch Next? | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `#/dashboard` | Mission Control | Core | live-locked flagship | CEO B overview for market OS state, source gaps, watchlists, alerts, risk, and next mission. | Low/Medium | Maybe | Touch only for visual polish after B approves. |
...
| Route | Display Name | Group | Status | Current Purpose | Risk Level | Should Touch Next? | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `/` | Root / Alerts | Legacy / Compatibility | stable | Static root/home entry, currently Alerts Desk. | Low | No | Keep GitHub Pages safe. |
| `/app/alerts` | Alerts Compatibility | Legacy / Compatibility | stable | Legacy planned trigger/alerts center route. | Low | No | Compatibility route only. |
| `/market-command` | Market Command | Legacy / Compatibility | bridge | Legacy market route. | Medium | No | Bridges into existing command/signals concepts. |
| `/signal-engine` | Signal Engine | Legacy / Compatibility | bridge | Legacy signals route. | Medium | No | Signals route remains primary. |
| `/life-habitat` | Life Habitat | Legacy / Compatibility | prototype | Life habitat concept. | Medium | No | Do not expand into device/control work. |
| `/founder` | Founder | Legacy / Compatibility | stable/prototype | Founder identity and CEO B bridge. | Low | No | Keep as identity context. |
| `/ceo-b-profile` | CEO B Profile | Legacy / Compatibility | stable/prototype | CEO B profile route. | Low | No | Keep as identity context. |
| `/jarvis-lab` | Jarvis Lab | Legacy / Compatibility | prototype | Typed command/Jarvis research only. | High | No | No voice/camera/device control. |
| `/life-os` | Life OS | Legacy / Compatibility | prototype | Future device/life OS overview. | High | No | Future adapter only. |
| `/ai-handoff` | AI Handoff | Legacy / Compatibility | local-only | Copy/paste context endpoint for Codex/ChatGPT. | Medium | Maybe | Keep local-only; no public vault content. |
